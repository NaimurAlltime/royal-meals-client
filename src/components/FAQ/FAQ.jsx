      ...
      <div className="row row-cols-1 row-cols-md-2 g-4 mt-4">
        ...
        <div className="col">
          ...
          <p>
            ...
            Companies that deliver excellent customer service take the time
            needed to understand the needs of their unique customer base.
          </p>
        </div>
        <div className="col">
          <h2 style={{ color: "#43121d" }} className="fs-4 fw-semiBold">
          ...
          <p>
            This includes debit cards, credit cards, electronic funds transfers,
            direct credits, direct debits, internet banking and e-commerce
            payment systems. Payment systems may be physical or electronic and
            each has its own procedures and protocols.
          </p>
        </div>
        <div className="col">
          <h2 style={{ color: "#43121d" }} className="fs-4 fw-semiBold">
          ...
          <p>
            ...
            choice when they arrive. For the most part, diners don't have to put
            down a deposit to reserve a table and the check is settled after the
            meal has ended.
          </p>
        </div>
      </div>
