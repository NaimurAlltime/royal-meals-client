    ...
    <Container>
      <div className="mt-5">
        ...
        <div className="row row-cols-1 row-cols-md-3 g-4">
          <div className="col">
            <div className="card h-100" style={{ width: "384px" }}>
              <img
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  Pasta of several starchy food preparations frequently
                  associated with Italian cuisine and made from semolina, the
                  granular product...
                </p>
          ...
          <div className="col">
            <div className="card h-100" style={{ width: "384px" }}>
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  A fish fry is a meal containing battered or breaded fried
                  fish. It usually also includes french fries, coleslaw,
                  macaroni salad...
                </p>
                <Button variant="outline-danger">View Details </Button>
              </div>
